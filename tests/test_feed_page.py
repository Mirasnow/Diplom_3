...
class TestFeedPage:
    ...
    def test_click_on_order_opens_details_popup_window(self, browser_driver):
        ...
        feed_page.click_order_new_window(browser_driver, Mpl.feed_button,Fpl.orders_number)
    ...
    def test_user_order_displayed_on_feed_page(self, browser_driver, create_user):
        feed_page = FeedPage(browser_driver)
        order_responce, order_ui = feed_page.user_orders_in_feed(browser_driver, create_user, Mpl.feed_button,
    ...
    def test_increase_counter(self, browser_driver, create_user, counter_locator, description):
        feed_page = FeedPage(browser_driver)
        count_before_order, count_after_order = feed_page.count_increase(browser_driver, create_user,
    ...
    def test_order_number_displayed_in_progress_section(self, browser_driver, create_user):
        feed_page = FeedPage(browser_driver)
        order_number, order_ui = feed_page.number_order_in_progress(browser_driver, create_user, Mpl.feed_button,
